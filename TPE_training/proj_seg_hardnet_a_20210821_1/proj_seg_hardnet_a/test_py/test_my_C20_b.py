...
def init_dataloader(args):
    ...
    path_root = '/home/yu1/Desktop/temp_dir/Dataset_railsem19/rs19_val_20200417'

    ###
    data_loader = get_loader(args.dataset)
    loader = data_loader(fpath_root=path_root, b_do_transform=True)
...
def process_img_my(img_path, size, device, model, loader):
    ...
    img = misc.imresize(img, (loader.size_img_rsz[0], loader.size_img_rsz[1]))
    ...
    decoded = loader.decode_segmap_b(pred)
    ...
    ###
    img_res_final = cv2.addWeighted(src1=img_resized_bgr, alpha=0.45, src2=decoded, beta=0.55, gamma=0)
    #cv2.imshow('img_hmap_b', img_hmap_final)
    #cv2.imwrite(fname_out_img, img_hmap_rgb)
    #cv2.waitKey(1)


    return img_resized, decoded, img_res_final
#end
...
def test(args):
    ...
    for img_file in sorted(os.listdir(args.input)):
        ###
        ...
        ###
        img, decoded, img_res_final = process_img_my(img_path, proc_size, device, model, loader)

        out_path = os.path.join(args.output, os.path.basename(img_file))
        #cv2.imwrite(out_path, blend)
        cv2.imwrite(out_path, img_res_final)
...
########################################################################################################################
#   --model_path /home/yu1/PycharmProjects/proj_seg_hardnet_a/runs/hardnet_railsem19_my2_20200502_1/cur/hardnet_railsem19_best_model.pkl
#   --dataset railsem19
#   --size 540,960
#   --input /home/yu1/Desktop/temp_dir/Dataset_railsem19/rs19_val_20200417/jpgs/rs19_val/rs07000.jpg
#   --input /media/yu1/hdd_my/Dataset_YDHR_OCT009_OCT10/img_gopro/selected/test7_run2_normal_reverse_switch/GH060008_0805_1570734365.5_20191010-150605.jpg
#   --output /home/yu1/Desktop/temp2
#=======================================================================================================================
# <for testing only image>
#   --model_path /home/yu1/PycharmProjects/proj_seg_hardnet_a/runs/hardnet_railsem19_my2_20200502_1/cur/hardnet_railsem19_best_model.pkl  --dataset railsem19  --size 540,960  --input /media/yu1/hdd_my/Dataset_YDHR_OCT009_OCT10/img_gopro/selected/test7_run2_normal_reverse_switch/GH060008_0805_1570734365.5_20191010-150605.jpg  --output /home/yu1/Desktop/temp2
#   --input /home/yu1/Desktop/temp_dir/Dataset_railsem19/rs19_val_20200417/jpgs/rs19_val/rs07000.jpg
#=======================================================================================================================
# <for testing image in a folder>
...
#=======================================================================================================================
# <for testing image in a folder>
#   --model_path /home/yu1/PycharmProjects/proj_seg_hardnet_a/runs/hardnet_railsem19_C20_my_20200603_1/cur/hardnet_railsem19_C20_best_model.pkl  --dataset railsem19_C20  --size 540,960  --input /media/yu1/hdd_my/Dataset_YDHR_OCT009_OCT10/img_gopro/selected/test7_run2_normal_reverse_switch  --output /home/yu1/Desktop/temp3a
########################################################################################################################
