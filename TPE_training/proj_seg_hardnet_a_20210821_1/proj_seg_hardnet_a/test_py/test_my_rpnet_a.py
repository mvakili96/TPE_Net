...
def process_img_my(full_fname_img_raw_jpg, size, device, model, loader, param_name_model):
    ...
    elif param_name_model["arch"] is "rpnet_a":
...
if __name__ == "__main__":
    ...
    ### (1) set parameters
    ###============================================================================================================
    param_file_weight = "/home/yu1/PycharmProjects/proj_seg_hardnet_a/runs/rpnet_a_railsem19_seg_triplet0/cur/rpnet_a_railsem19_seg_triplet_best_model.pkl"
    ...
    for fname_img in list_fnames_img:
        ...
        ###
        ###------------------------------------------------------------------------------------------------
        img_raw_in, img_res_seg, img_res_hmap = process_img_my(full_fname_img, proc_size, device, model, loader, param_name_model)
