...
param_scale_pixel_m = 20.0          # oo pixel/meter
param_h_img_bev = 480
param_w_img_bev = 240
...
###
pnt_in_bev1 = transform_cam_to_bev(pnt_in_cam1[1], pnt_in_cam1[0], param_scale_pixel_m, param_offset_y, param_offset_x)
pnt_in_bev2 = transform_cam_to_bev(pnt_in_cam2[1], pnt_in_cam2[0], param_scale_pixel_m, param_offset_y, param_offset_x)
pnt_in_bev3 = transform_cam_to_bev(pnt_in_cam3[1], pnt_in_cam3[0], param_scale_pixel_m, param_offset_y, param_offset_x)
pnt_in_bev4 = transform_cam_to_bev(pnt_in_cam4[1], pnt_in_cam4[0], param_scale_pixel_m, param_offset_y, param_offset_x)
...
for fname_img_in in list_fnames_img:
    ...
    # kernel_sharpening = np.array([[-0.5, -0.5, -0.5], [-0.5, 5.0, -0.5], [-0.5, -0.5, -0.5]])
    # img_dst_b = cv2.filter2D(img_dst, -1, kernel_sharpening)
